...
const MessageBar: React.FC<{ onMessageSend: (messageText: string) => void }> = ({ onMessageSend }) => {
...
const ChatPage: React.FC = () => {
  ...
  return (
    <React.Fragment>
      {messages.map((message, index) => <ChatBubble key={index} {...message} onSystemMessage={onSystemMessage} />)}
